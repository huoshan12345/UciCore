...
public static class TestConfigs
{
    ...
    private static string ReadTestFile(string fileName)
    {
        return TestDataDir
            ...
            .Pipe(m => File.ReadAllText(m));
    }

    public static readonly string OpenClash = ReadTestFile("openclash");
    public static readonly string OpenClashUci = ReadTestFile("openclash.uci");
    public static readonly string OpenClashJson = ReadTestFile("openclash.json");
